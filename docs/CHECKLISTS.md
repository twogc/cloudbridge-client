...
| **Track B gRPC** `scripts/grpc-smoke.sh` / tunnel | PASS Hello+Auth+**CreateTunnel** |
| **Full QUIC** `scripts/quic-smoke` | PASS dial :5553 + **AUTH_OK** |
| Combined `scripts/tunnel-quic-smoke.sh` | PASS `TUNNEL_QUIC_SMOKE_PASS=1` |
